<template>
    <v-layout column>
        <v-flex v-if="hasPlans && gorisont" xs12>
                    ...
                    <div :class="{'_v-btn-content': true, '_with-description': item.description}">
                        ...
                        <div class="_details-price">
                            ...
                            <div class="" v-if="isSave(item)">
                                <span v-if="isSave(item)" class="_price-all font--light">${{item.price}}</span>
        ...
        <v-flex v-if="hasPlans && !gorisont" xs12>
            <v-btn-toggle v-model="select"
                          mandatory
                          class="app-show-plan align-center elevation-0">
                <v-btn v-for="item in plans"
                       :key="item.id"
                       :ripple="false"
                       :value="item"
                    ...
                    <div :class="{'_v-btn-content': true, '_with-description': item.description}">
                        ...
                        <div class="_details-price">
                            <div v-if="isSave(item)"
                                  class="font--light" style="padding-right: 10px">
                                Save {{ item | savePer }}%
                            </div>
                            <div class="" v-if="isSave(item)">
                                <span v-if="isSave(item)" class="_price-all font--light" style="padding-right: 10px">${{Math.round(item.price)}}</span>
                                <span style="padding-right: 10px">${{Math.round(item.price_all)}}</span>
                            </div>
                            <div class="" v-if="!isSave(item)">
