...
export const SOCKET_URL = 'http://nanny-granny-uat-lb-934519003.ap-southeast-2.elb.amazonaws.com:3000'
export const API_BASE_URL = 'http://nanny-granny-uat-lb-934519003.ap-southeast-2.elb.amazonaws.com/api/v1/'
export const IMAGE_BASE_URL = 'http://nanny-granny-uat-lb-934519003.ap-southeast-2.elb.amazonaws.com/'
